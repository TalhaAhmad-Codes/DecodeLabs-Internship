...
# Project 2: Creating an API in Backend
...
- **Step 1:** Open your terminal and type this command `node server.js`, and open the link with browser.
- **Step 2:** Open **Postman** and add this link `http://localhost:3000/` to test the API.
